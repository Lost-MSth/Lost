...
def adJGrTXOYQ(adJGrTXOYo):
    ...
    if adJGrTXOYo != None:
        ...
        print(r, adJGrTXOYo.OOO0)
        x.append((r, adJGrTXOYo.OOO0))
        s += bytes([adJGrTXOYo.OOO0 ^ r])
...
def adJGrTXOYD():
    ...
    adJGrTXOYh = [chr(i) for i in range(36)]
    ...
    adJGrTXOYU = base64.b64decode(
        "7EclRYPIOsDvLuYKDPLPZi0JbLYB9bQo8CZDlFvwBY07cs6I")
    y = [0] * 36
    for i, j in zip(adJGrTXOYU, x):
        print(chr(i ^ j[0]))
        y[j[1]] = chr(i ^ j[0])
